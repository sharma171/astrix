            ...
            <div className="bigcontainer">
                <div className="row-flex">
                    ...
                    <div className="col-flex evnt-col">
                        <div className={`form ${activeItem === 'Events' ? 'active' : ''}`}>
                        ...
                        <div className={`form ${activeItem === 'Collections' ? 'active' : ''}`}>
                            <h3 className="topheading">
                            ...
                            <div className="collectibles row-flex">
                                <img src={Collectimg1} alt="" className="collect-img" />
                            </div>
                            <div className="submit-row row-flex">
                                <img src={QrIcon} alt="" className="qricon"/>
                                <button className="submit">Join Waitlist</button>
